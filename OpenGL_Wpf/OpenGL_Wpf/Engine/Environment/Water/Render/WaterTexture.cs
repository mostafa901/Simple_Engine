...
namespace InSitU.Views.ThreeD.Engine.Water.Render
{
    internal class WaterTexture : Base_Texture
    {
        ...
        public WaterTexture(TextureMode textureTargetType) : base(textureTargetType)
        {
            ...
            TextureIds.Add(new TextureSample2D(@"D:\Revit_API\Projects\InSitU\InSitU\Views\ThreeD\Engine\Water\Render\Source\WaterNoise.png", TextureUnit.Texture2));
            TextureIds.Add(new TextureSample2D(@"D:\Revit_API\Projects\InSitU\InSitU\Views\ThreeD\Engine\Water\Render\Source\WaterNormalMap.png", TextureUnit.Texture3));
